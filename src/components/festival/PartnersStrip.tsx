          ...
          <div className="marquee-mask" style={{ overflow: "hidden" }}>
            <div className="animate-marquee" style={{ display: "flex", width: "max-content", alignItems: "center", gap: "6rem" }}>
              {loop.map((sp, i) => {
                ...
                const inner = hasLogo ? (
                  <div style={{ height: 200, display: "flex", alignItems: "center", justifyContent: "center", padding: "1.25rem 1.875rem", borderRadius: "1rem", background: "white", boxShadow: "0 4px 24px rgba(0,0,0,0.08)", border: "1px solid var(--border)", transition: "all 0.3s", minWidth: 250 }}>
                    <img
                      src={sp.logo_url!}
                      alt={sp.name}
                      style={{ maxHeight: 150, maxWidth: 250, width: "auto", objectFit: "contain", transition: "all 0.3s" }}
                  ...
                  <div style={{ height: 200, minWidth: 250, borderRadius: "1rem", background: "white", border: "1px solid var(--border)", display: "grid", placeItems: "center", padding: "0 1.875rem", fontSize: "0.875rem", fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", color: "var(--muted-foreground)", textAlign: "center", boxShadow: "0 4px 24px rgba(0,0,0,0.08)" }}>
                    {sp.name}
                  </div>
                );
